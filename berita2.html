    ...
    <section class="pt-32 pb-16 px-6 bg-gray-50">
        <div class="container mx-auto">
            <div class="max-w-4xl mx-auto">
                <h1 class="text-4xl font-bold text-sky-500 mb-6">Informasi Daftar Ulang</h1>
                ...
                <img src="./img/berita 2.2.png" alt="Penerimaan Siswa Baru Tahun 2024" class="w-full h-96 object-cover rounded-lg mb-8">
                <div class="text-gray-700 leading-7">
                    <p class="mb-6">
                    SMA IT HSI IDN mengumumkan bahwa proses daftar ulang untuk siswa baru tahun ajaran 2024/2025 telah resmi dibuka. Bagi siswa yang telah dinyatakan lulus seleksi PPDB, wajib melakukan daftar ulang sesuai dengan jadwal yang telah ditentukan oleh pihak sekolah. Proses daftar ulang ini bertujuan untuk memastikan bahwa para siswa baru telah terdaftar secara resmi sebagai bagian dari keluarga besar SMA IT HSI IDN.
                    </p>
                    <p class="mb-6">
                        Proses daftar ulang akan dilakukan secara langsung di kantor administrasi SMA IT HSI IDN mulai tanggal 10 hingga 20 September 2024. Para orang tua atau wali murid diharapkan membawa dokumen yang diperlukan seperti surat keterangan lulus seleksi, bukti pembayaran biaya pendidikan, pas foto terbaru, serta dokumen lain yang telah diinformasikan sebelumnya. Petugas akan membantu memastikan seluruh proses berjalan lancar dan sesuai prosedur.
                    </p>
                    <p class="mb-6">
                        Selain itu, selama masa daftar ulang, siswa baru juga akan mengikuti sesi orientasi untuk mengenal lebih dekat lingkungan sekolah, kurikulum, serta program-program unggulan yang akan mereka jalani selama bersekolah di SMA IT HSI IDN. Sesi ini bertujuan untuk mempersiapkan siswa agar dapat beradaptasi dengan baik dan siap menghadapi tahun ajaran baru dengan semangat yang tinggi. Untuk informasi lebih lanjut, silakan menghubungi pihak sekolah atau mengunjungi situs <a href="index.html" class="text-sky-500 underline">web resmi</a> SMA IT HSI IDN.
                    </p>
                </div>
