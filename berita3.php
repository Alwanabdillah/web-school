    ...
    <section class="pt-32 pb-16 px-6 bg-gray-50">
        <div class="container mx-auto">
            <div class="max-w-4xl mx-auto">
                <h1 class="text-4xl font-bold text-sky-500 mb-6">Informasi Pengumuman PPDB</h1>
                ...
                <img src="./img/berita 3.2.png" alt="Penerimaan Siswa Baru Tahun 2024" class="w-full h-96 object-cover rounded-lg mb-8">
                <div class="text-gray-700 leading-7">
                    <p class="mb-6">
                    SMA IT HSI IDN dengan gembira mengumumkan hasil seleksi Penerimaan Peserta Didik Baru (PPDB) untuk tahun ajaran 2024/2025. Para calon siswa yang telah mengikuti seluruh tahapan seleksi dapat melihat pengumuman hasil akhir melalui situs resmi SMA IT HSI IDN pada tanggal 5 September 2024. Untuk melihat hasilnya, silakan masuk ke laman pengumuman dengan memasukkan nomor pendaftaran dan tanggal lahir sesuai petunjuk yang tersedia.
                    </p>
                    <p class="mb-6">
                        Bagi calon siswa yang dinyatakan lulus, selamat bergabung menjadi bagian dari keluarga besar SMA IT HSI IDN! Selanjutnya, para siswa diwajibkan mengikuti prosedur daftar ulang yang akan dilaksanakan mulai tanggal 10 hingga 20 September 2024. Harap memastikan seluruh dokumen yang diperlukan telah lengkap dan mengikuti arahan yang telah disampaikan oleh pihak sekolah untuk kelancaran proses daftar ulang.
                    </p>
                    <p class="mb-6">
                        Bagi calon siswa yang belum dinyatakan lulus, jangan berkecil hati. Kami mengapresiasi setiap usaha dan semangat yang telah ditunjukkan selama proses seleksi ini. SMA IT HSI IDN tetap membuka berbagai program pendidikan lainnya yang dapat menjadi pilihan bagi calon siswa untuk tetap berkontribusi dan belajar bersama dalam semangat Islami dan teknologi modern. Terima kasih atas partisipasi dan antusiasme semua pihak dalam PPDB tahun ini.
                    </p>
                </div>
